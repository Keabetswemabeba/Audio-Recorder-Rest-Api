...
const projectId = "audio-app-4b919";
...
const storageBucket = "audio-app-4b919.appspot.com";
const storageUrl = `https://storage.googleapis.com/storage/v1/b/${storageBucket}/o`;

// the reference to where the recordings are going to be
...
export default function AudioRecorder() {
    ...
    const [storageFileUrl, setStorageFileURL] = useState(null);
    ...
    const stopRecording = async () => {
        try {
            ...
            console.log("Storage file url:", storageFileUrl);
            console.error(error);
    ...
    const deleteRecording = async (id, audioName) => {
        try {
            ...
            await fetch(`https://storage.googleapis.com/storage/v1/b/${storageBucket}/o/audio%2F${audioName}`, {      // https://storage.googleapis.com/storage/v1/b/${storageBucket}/o/audio%2F${userId}%2F${audioName}
                method: 'DELETE',
            });
    ...
    return (
        <View style={styles.container}>
            ...
            <Card containerStyle={{ marginTop: 15, marginBottom: 15, height: 300, width: 300, borderRadius: 10, backgroundColor: '#fff', }}>
                ...
                {recording ? (
                    ...
                    <TouchableOpacity onPress={startRecording}>
                        <FontAwesomeIcon icon={faMicrophone} size={30} color="blue" />
                    </TouchableOpacity>
                )}
            ...
            <Card containerStyle={{ marginTop: 15, marginBottom: 15, height: 300, width: 300, borderRadius: 10, backgroundColor: 'black', }}>
